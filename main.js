...
const Hamz = global.nomorowner //here notification clear session to owner
...
const connectionOptions = {
    ...
    syncFullHistory: false,//true so you can read commands when the bot is offline 
...
async function connectionUpdate(update) {
    ...
    if (connection == 'close') {
        console.log(chalk.red(`📡 connection lost Try reconnectingt`));
    }
}
...
setInterval(async () => {
    ...
    await clearTmp();
    conn.reply(Hamz + '@s.whatsapp.net', 'Sessions telah dibersihkan', null) >
